...
<p>We should have started lesson content earlier instead of focusing so heavily on vault and quiz systems. The features were great, but they depend on strong lesson design.</p>
</div>
</div>
...
<p>When someone hit a roadblock, we would:</p>
<ol>
...
<ul>
  <li>Code reviews before pushing (our theme broke once because we didn't)</li>
  <li>Consistent naming conventions (permalink confusion was real)</li>
</ul>
</div>
...
<ul>
  ...
  <li>Responsive design and clean navigation</li>
</ul>
...
<p>Despite what I'd change, I was proud of:</p>
<ul>
  <li>The vault's functionality and animations</li>
  <li>The quiz save system</li>
  <li>How well our team collaborated</li>
  <li>Actually finishing a polished project</li>
</ul>
</div>
